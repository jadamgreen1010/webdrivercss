...
module.exports = function(done) {
     ...
     * The dummy is a workaround to make webdriverio not steal and apply the real callback after the command is done.
     */
    this.instance.pause(100).saveDocumentScreenshot(this.screenshot, done, function dummy(){} );
